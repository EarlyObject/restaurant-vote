...
public class MealTestData {
    ...
    public static final Meal MEAL1 = new Meal(1016, CURRENT_DATE, "Лагман", 20, 1007);
    public static final Meal MEAL2 = new Meal(1017, CURRENT_DATE, "Блинчики с мясом", 25, 1007);
    public static final Meal MEAL3 = new Meal(1018, CURRENT_DATE, "Бастурма", 5, 1008);
    public static final Meal MEAL4 = new Meal(1019, CURRENT_DATE, "Шашлык", 50, 1009);
